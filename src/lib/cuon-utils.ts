// cuon-utils.ts (c) 2012 kanda and matsuda
 ...
 */
function getWebGLContext(canvas: HTMLCanvasElement, opt_debug?: boolean): WebGLRenderingContext | null {
...
export { createProgram, getWebGLContext, initShaders, loadShader }
