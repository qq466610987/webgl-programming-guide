...
function main() {
  ...
  if (!u_rotationMatrix) {
    console.error('Failed to get the storage location of u_RotationMatrix')
    return
  }
  const rotationMatrix = new Matrix4()
  rotationMatrix.setRotate(90, 0, 0, 1) // 沿着Z轴旋转90度
...
<template>
  <div class="demo-container">
    <div class="demo-header">
      <h2>从指定视点观察旋转后的三角形</h2>
      <p>
        演示视图矩阵和旋转矩阵的使用,<br>
        “从视点看上去”的三角形顶点坐标 = 视图矩阵 x 旋转矩阵 x 原始三角形顶点坐标
      </p>
    </div>
